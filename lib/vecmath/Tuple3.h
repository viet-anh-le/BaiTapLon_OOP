...
public:
    ...
    /**
     * Returns true if all of the data members of Tuple3 t1 are equal to the
    ...
    /**
     * Returns a string that contains the values of this Tuple3. The form is
     * (x,y,z).
    ...
    bool operator==(const Tuple3 &t1) const { return equals(t1); }
    ...
    Tuple3 operator*(T s) const { return (Tuple3(*this)).operator*=(s); }
};
...
VM_IOSTREAM_STD::ostream &operator<<(VM_IOSTREAM_STD::ostream &o,
                                     const VM_VECMATH_NS::Tuple3<T> &t1) {
...
template<class T>
inline VM_VECMATH_NS::Tuple3<T> operator*(T s,
                                          const VM_VECMATH_NS::Tuple3<T> &t1) {

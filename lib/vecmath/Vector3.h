...
public:
    ...
    void cross(const Vector3 &v1, const Vector3 &v2) {
        ...
        this->set(v1.y * v2.z - v1.z * v2.y, v1.z * v2.x - v1.x * v2.z,
                  v1.x * v2.y - v1.y * v2.x);
    }
...
template<class T>
inline VM_VECMATH_NS::Vector3<T>
operator*(T s, const VM_VECMATH_NS::Vector3<T> &t1) {
...
operator<<(VM_IOSTREAM_STD::ostream &o, const VM_VECMATH_NS::Vector3<T> &t1) {
